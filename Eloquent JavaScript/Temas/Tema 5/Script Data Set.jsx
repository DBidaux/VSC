...
//Real Use of Filter (not like above)//
...
//Summarizing with reduce (adding loop, reminds me to the Fibonacci's number)//
...
//Create the function in the spot that where be used//
...
//Composability --> without high order functions --> more legibility, less speed in huge arrays//

let biggest = null;
for (let script of SCRIPTS) {
  if (biggest == null ||
    charCount(biggest) < charCount(script)) {
      biggest = script;
    }
}
console.log(biggest);
...
//You can write like a loop  --> less legibility, more speed//
...
console.log("--");
console.log(charScript(9944));
console.log("--");
console.log(charScript(354));
